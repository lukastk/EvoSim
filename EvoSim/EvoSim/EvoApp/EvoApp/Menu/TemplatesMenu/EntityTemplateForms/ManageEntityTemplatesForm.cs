...
{
	public class ManageEntityTemplatesForm : Dialogue
	{
		ColumnListBox columnListBox;

		public static ManageEntityTemplatesForm ShowDialogue(Window window, CloseEvent closeFunction = null, string category = null, ISkinFile file = null)
		{
			var form = new ManageEntityTemplatesForm();
			form.Initialize(closeFunction, "Manage Entity-Templates", true, true, category, file);
			form.Show(window);
